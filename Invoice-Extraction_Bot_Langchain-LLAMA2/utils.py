...
def create_docs(user_pdf_list):
    ...
    for filename in user_pdf_list:
        ...
        # data_dict = {}  # Initialize data_dict with an empty dictionary
        # if match:
        ...
        # Initialize data_dict before the if statement
        ...
        if match:
            extracted_text = match.group(1)
            extracted_text = extracted_text.replace('null', 'None')
            # Converting the extracted text to a dictionary
            try:
                data_dict = eval('{' + extracted_text + '}')
                print("Extracted data dictionary: ", data_dict)
            except SystemError:
                print("Error: Unable to evalutate text as a dictionary")
        else:
            print("No match found.")
